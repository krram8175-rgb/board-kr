...
export const BLUEPRINTS = {
  ...
  math: {
    ...
    parts: [
      { key: "A", mark: "1", qs: "20", qCount: "20/20", mCount: "20/20" },
      { key: "B", mark: "2", qs: "9", qCount: "06/09", mCount: "12/18" },
      { key: "C", mark: "3", qs: "9", qCount: "06/09", mCount: "18/27" },
      { key: "D", mark: "5", qs: "7", qCount: "04/07", mCount: "20/35" },
      { key: "E", mark: "6", qs: "2", qCount: "01/02", mCount: "06/12" },
    ],
    rows: [
      row("1", 1, "Relations and Functions", 9, 9, { A: 1, B: 1, C: 1, D: 1, E: "" }),
      row("2", 2, "Inverse Trigonometric Functions", 6, 6, { A: 1, B: 1, C: 1, D: "", E: "" }),
      row("3", 3, "Matrices", 9, 9, { A: 1, B: "", C: 1, D: "", E: "" }),
      row("4", 4, "Determinants", 12, 12, { A: 1, B: 1, C: 1, D: 1, E: "" }),
      row("5", 5, "Continuity and Differentiability", 20, 17, { A: 3, B: 1, C: 1, D: 1, E: 1 }),
      row("6", 6, "Application of Derivatives", 10, 8, { A: 3, B: 1, C: 1, D: "", E: "" }),
      row("7", 7, "Integrals", 22, 18, { A: 2, B: 1, C: 1, D: 1, E: "" }),
      row("8", 8, "Application of Integrals", 5, 5, { A: "", B: "", C: "", D: 1, E: "" }),
      row("9", 9, "Differential Equations", 10, 8, { A: 1, B: 1, C: 1, D: "", E: "" }),
      row("10", 10, "Vector Algebra", 11, 8, { A: 3, B: 1, C: 1, D: "", E: "" }),
      row("11", 11, "Three Dimensional Geometry", 8, 6, { A: 1, B: 1, C: 1, D: "", E: "" }),
      row("12", 12, "Linear Programming", 7, 6, { A: "", B: "", C: 1, D: "", E: 1 }),
      row("13", 13, "Probability", 11, 8, { A: 3, B: 1, C: 1, D: "", E: "" }),
    ],
  },
};
